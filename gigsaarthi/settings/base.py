...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': config('CLOUDINARY_CLOUD_NAME', default='ldalhgtk'),
    'API_KEY': config('CLOUDINARY_API_KEY', default='176297288299611'),
    'API_SECRET': config('CLOUDINARY_API_SECRET', default='cnDpZZj_P8rasUx8oV1Zs5qN-pw'),
}
